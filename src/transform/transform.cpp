...
static bool Transform::checkPointInside(Transform::Point point, std::vector<Transform::Point> shape) {
...
bool Transform::checkInside(std::vector<Transform::Point> shape1, std::vector<Transform::Point> shape2) {
...
bool Transform::checkLineSegmentIntersection(Transform::Point p1, Transform::Point p2,
...
bool Transform::checkOverlap(std::vector<Transform::Point> shape1, std::vector<Transform::Point> shape2) {
